      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        <Reveal>
          <SectionHeading
            ...
            subtitle="Plannio helps groups agree on times — from weekend trips to team meetings — with date ranges, flexible times, and updates straight to Discord."
          />
        </Reveal>
            ...
            <div className="group flex h-full flex-col justify-between overflow-hidden rounded-3xl border border-border bg-card p-8 shadow-card">
              <div className="max-w-md">
                ...
                <p className="mt-2 text-muted-foreground">
                  Share the poll link in Discord or anywhere else. Participants pick the dates that
                  work for them and you watch results update in real time.
                </p>
              </div>
        ...
        <div className="mt-4 grid gap-4 sm:grid-cols-3">
          <Reveal>
            <FeatureCard
              ...
              body="Connect a Discord channel when you create a poll. Plannio posts when the poll is created, when someone votes, and when everyone has responded."
            />
          </Reveal>
          <Reveal delay={0.05}>
            <FeatureCard
              ...
              body="Set how many people should respond so you can track progress (e.g. 3 / 8) and get notified in Discord when everyone is done."
            />
          </Reveal>
          <Reveal delay={0.1}>
            <FeatureCard
              ...
              body="Automatic nudges for people who haven't voted yet — so you don't have to chase them manually."
            />
          </Reveal>
        </div>
      </div>
